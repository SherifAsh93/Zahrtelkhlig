  ...
  return (
    <>
      <header className="bg-white shadow-sm sticky top-0 z-50">
        {/* Top bar */}
        <div className="bg-brand-600 text-white text-xs py-1.5 px-4">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            <div className="flex items-center gap-3">
              <a href="https://web.facebook.com/zahrtelkhlig" target="_blank" rel="noopener noreferrer" className="hover:text-brand-200 transition-colors" aria-label="فيسبوك">
              ...
              <a href="https://www.instagram.com/zahretelkhaleej.c/" target="_blank" rel="noopener noreferrer" className="hover:text-brand-200 transition-colors" aria-label="انستجرام">
            ...
            <span>شحن مجاني للطلبات فوق 500 جنيه | الدفع عند الاستلام متاح</span>
            <span className="hidden sm:block opacity-0">placeholder</span>
          </div>
        </div>
