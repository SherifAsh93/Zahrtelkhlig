        ...
        <div className="bg-gray-900 text-white text-xs py-1.5 px-4 overflow-hidden">
          ...
          <div className="sm:hidden">
            <div className="marquee-track whitespace-nowrap uppercase tracking-widest">
              <span className="inline-block px-4">شحن داخل وخارج دمياط &nbsp;•&nbsp; للطلبات: 01002001446 &nbsp;•&nbsp; الدفع عند الاستلام</span>
              <span className="inline-block px-4">شحن داخل وخارج دمياط &nbsp;•&nbsp; للطلبات: 01002001446 &nbsp;•&nbsp; الدفع عند الاستلام</span>
            </div>
          </div>
          ...
          <div className="hidden sm:flex max-w-7xl mx-auto items-center justify-between">
            ...
            <span className="uppercase tracking-widest">شحن داخل وخارج دمياط &nbsp;•&nbsp; للطلبات: <span dir="ltr">01002001446</span> &nbsp;•&nbsp; الدفع عند الاستلام</span>
