    ...
    >
      {products.map((product) => (
        <Link
          ...
          style={{ scrollSnapAlign: 'start', width: 'clamp(145px, 40vw, 215px)' }}
        >
          <div className="relative overflow-hidden bg-gray-50" style={{ aspectRatio: '2/3' }}>
            ...
            {product.stock === 0 && (
              <div className="absolute inset-0 bg-black/25 flex items-center justify-center">
                <span className="text-white text-[10px] uppercase tracking-widest font-cairo bg-black/40 px-3 py-1">نفذ</span>
              </div>
            )}
          </div>
          <div className="pt-3" dir="rtl">
            <p className="text-[10px] text-gray-400 font-cairo uppercase tracking-wider mb-0.5">زهرة الخليج</p>
